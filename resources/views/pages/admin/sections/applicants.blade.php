                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 ">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <a href="{{ route('admin.verify', ['currentRoute' => 'applicant', 'applicantId' => $applicant->applicant_id]) }}" class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg hover:bg-gray-100 hover:rounded-full">
