...
<a href="" class="flex items-center gap-5 text-white transition-all duration-300 ease-in h-14 w-11/12 pl-5 {{$currentRoute == 'dashboard' ? 'bg-white text-black' : ''}}">
    <span class="material-symbols-sharp">dashboard</span>
    <h3>Dashboard</h3>
</a>

<a href="" class="flex items-center gap-5 text-white transition-all duration-300 ease-in h-14 w-11/12 pl-5 {{$currentRoute == 'applicants' ? 'bg-white text-black' : ''}}">
