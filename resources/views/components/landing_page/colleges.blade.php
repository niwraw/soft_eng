<div class="flex items-center w-full h-auto py-8 px-26 justify-normal">
    <div class="w-full text-2xl max-w-10/12 h-max">
        <div class="pb-4 mb-6 border-b-2 border-yellow-400 border-solid">
            <h1>Colleges</h1>
        </div>

        <h3 class="mb-4 text-lg">Quality education meets compassion</h3>

        <p class="mb-4 text-base text-justify">Whether you choose to do in the corporate work, non-government or government work or anything in between, you’re guaranteed to possess both the technical skills and compassion that truly sets PLM graduates apart from the rest.</p>
